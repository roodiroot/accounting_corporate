...
1.  **ОБЩИЕ ПОЛОЖЕНИЯ**
    ...
    1.1. Настоящая политика конфиденциальности (далее — Политика) определяет основные принципы, цели, условия и способы обработки персональных данных ООО Партнер (ОГРН 1181326005640, ИНН 1324002754, юридический адрес: 431444, Республика Мордовия, город Рузаевка, ул. 40 лет Победы, д. 3в, кв. 40 ) (далее — Оператор).
...
8. **ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ**
   ...
   8.2. Настоящей Политикой утверждена форма Согласия на обработку персональных данных пользователей Сайта (Приложение №1 к настоящей Политике), которая размещается на Сайте в публичном доступе по ссылке: https://partner-biznes.ru/docs/pd-consent.

9. **РЕКВИЗИТЫ ОПЕРАТОРА**

Наименование: **ООО «Партнер»**

Адрес: **431444, Республика Мордовия, город Рузаевка, ул. 40 лет Победы, д. 3в, кв. 40**

ОГРН:**1181326005640**

ИНН **1324002754**

Адрес электронной почты: **ooopartner13@yandex.ru**

Телефон: **+7 (917) 695-79-62**

[Согласие на обработку персональных данных](/docs/pd-consent)
    ...
    <div className="relative bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className=" overflow-hidden flex justify-between items-start">
          <h2 className="text-3xl max-w-2xl lg:text-4xl text-balance">
            Политика <span className="text-accent">конфиденциальности</span> ООО
            Партнер
          </h2>
        </div>
        <ContentMarkdown content={privacyPolicy} />
      </div>
    </div>
  );
}
