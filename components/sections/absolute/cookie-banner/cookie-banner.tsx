...
const CookieBanner = () => {
  ...
  return (
    <div className="w-full  fixed bottom-4 left-4 z-20 bg-white rounded-lg shadow-2xl flex flex-col gap-3 p-3 max-w-[193px] sm:max-w-[482px] sm:flex-row md:flex-col md:max-w-[193px]">
      <p className="text-xs">
        Мы обрабатываем данные посетителей и используем куки согласно{" "}
        <a href="/docs/privacy-policy" target="_blank" className="text-accent">
          политике
        </a>
      </p>
      <button
