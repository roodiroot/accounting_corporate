        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:shrink-0 lg:pt-8">
          <div className="mt-24 sm:mt-32 lg:mt-0">
            <h1 className="mt-10 text-4xl font-bold tracking-tight sm:text-6xl">
              Надежный <span className="text-accent">эксперт</span> в бухгалтерском учете{' '}
              <span>
                <Image
                  alt="element"
                  width={174}
            ...
            <p className="mt-6 text-xl leading-8 text-secondary">
              Мы готовы стать частью вашей команды, обеспечивая надежный бухгалтерский учет и
              стратегическое планирование вашего успеха.
            </p>
            <ButtonCastom className="bg-accent mt-10">Консультация</ButtonCastom>
          </div>
        </div>
